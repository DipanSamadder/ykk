...
<table class="table table-bordered table-striped table-hover dataTable">
    <thead>
            <tr class="text-center">
                ...
                <th>Form Name</th>
                <th>Date</th>
                @if(dsld_have_user_permission('contact-form-leads') == 1 || dsld_have_user_permission('contact-form-leads_delete') == 1)
                <th>Action</th>
                @endif
            </tr>
        </thead>
                ...
                <tr>
                    ...
                    <td>
                        <p class="text-center mb-0 action_items">
                            ...
                            @if(dsld_have_user_permission('contact-form-leads_delete') == 1)
