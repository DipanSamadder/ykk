...
@section('content')
 <!-- Exportable Table -->
 <form id="update_form" action="{{ route('posts.update') }}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="card mb-0">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="visibility" id="visibility" onchange="is_edited()">
