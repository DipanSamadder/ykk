    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                <div class="col-lg-6">
                    @if(dsld_have_user_permission('permissions_add') == 1)
...
@section('footer')
    @include('backend.modules.roles.permissions.add')
    <input type="hidden" name="page_no" id="page_no" value="1">
<script>
    function add_new_lg_modal_form(){
        $('#add_new_larger_modals').modal('show');
        $('#add_new_larger_modals_tile').text('Add New Permission');
    }
